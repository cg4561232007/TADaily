...
QT_MOC_LITERAL(3, 24, 11) // "getDateTime"

    },
    "DefDateTimeEdit\0update\0\0getDateTime"
};
...
void DefDateTimeEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->update((*reinterpret_cast< const QDate(*)>(_a[1]))); break;
        case 1: _t->getDateTime((*reinterpret_cast< const QDate(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (DefDateTimeEdit::*_t)(const QDate & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DefDateTimeEdit::update)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void DefDateTimeEdit::update(const QDate & _t1)
{
